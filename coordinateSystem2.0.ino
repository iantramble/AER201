...
int leftnat, centnat, rightnat,linecount,desiredy;
...
void driveStraight(boolean dir){
  
  linecount = 0;
  while(linecount != desiredy)
    {
...
void turn(boolean lefty){
  ...
  if (lefty){  
    ...
    analogWrite(leftMotorForwards, 100);
    analogWrite(rightMotorBackwards, 100);
    delay(700);
    digitalWrite(rightMotorBackwards, LOW);
    digitalWrite(leftMotorForwards, LOW);
  }
